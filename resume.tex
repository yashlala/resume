...
\\ \itab{Linear Algebra} \tab{} 
	\tab{ Statistics}
\\ \itab{CS31-CS33: Experience in in C++/Data Structures, etc.} \tab{}  
	\tab{ Micro \& Macro-Economics} 
\\ \itab{CS33+35L: Computer Organization, Software Lab/Tools} \tab{}  
	\tab{ English Literature+Language } 
\\ \itab{Calculus+Differential Equations} \tab{} 
	\tab{ Physics (Mechanics and E\&M)}
...
\item Principal trumpet in the San Jose Youth Philharmonic. Beginning to
	experiment in Jazz Improvisation. 
\item Captain of High School Science Bowl team. Gained experience in Math, CS,
	Physics. 
