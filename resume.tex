...
\address{(510)-400-5572 \\ yashlala@g.ucla.edu \\ https://yashlala.github.io/}
...
\itab{CS 145 (ongoing): Introduction to Data Mining} \tab{} 
	\tab{CS 180: Algorithms} \\
\itab{CS 181: Formal Languages and Automata Theory} \tab{}
	\tab{Math 33A + 115AH (ongoing): Linear Algebra} \\
\itab{Coursera: Machine Learning (ongoing)}
